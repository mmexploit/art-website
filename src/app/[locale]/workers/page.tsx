...
const Workers = () => {
  ...
  return (
    <div className="w-full mx-auto mt-[20px] flex flex-col ">
      <div className="w-full flex flex-wrap items-center justify-between   border-b  px-[4%] md:px-[10%] py-3  mt-[15%] md:mt-[5%]">
    
        <p className="text-orange-500 text-lg md:text-2xl font-bold flex items-center gap-6">Available Experts</p>
        <Dialog >
          <DialogTrigger>
            <Button className="flex items-center gap-3 bg-primary hover:bg-primary text-white">Filter <FilterIcon className='hidden md:block'/></Button>
          </DialogTrigger>
          <DialogContent className="px-2 w-[96%] md:w-fit rounded-xl bg-white">
            ...
            <div className="flex flex-col items-start space-x-2 mb-4 lg:mb-0">
              ...
              <div className="flex flex-col  gap-3 py-2 ">
                ...
                <div className="flex items-center space-x-2 flex-col md:flex-row  gap-y-2">
                  <input
                    ...
                    className="border p-1 rounded text-black bg-white w-fit"
                  />
              ...
              <div className="w-full flex items-center">
                <Button onClick={clearFilters} variant="destructive" className="mx-auto bg-red-500">
                  Clear Filters
                </Button>
              </div>
            </div>
      ...
      :
            <div className="flex flex-wrap items-center justify-center gap-x-2 md:gap-x-8 gap-y-20 py-[20%] md:pt-[15%] z-0 ">
        {filteredMaids.map((maid) => (
          <Card key={maid._id} className="relative shadow-lg py-4 md:p-4 scale-[90%] md:scale-100 bg-primary text-white hover:shadow-xl">
            ...
            <CardFooter className="flex items-center justify-center">
                ...
                <Drawer>
                  <DrawerTrigger>
                     <Button className="flex items-center gap-3 bg-black hover:bg-black text-white" >View Detail <Eye /></Button>  
                  </DrawerTrigger>
                  <DrawerContent className='h-[85%] bg-white'>
                     <div className="h-[75%] overflow-y-auto px-6">
                      <DrawerHeader className='flex flex-col items-center justify-center'>
                      <DrawerTitle> <Image src={maid.imageUrl} alt={maid.name} width={180} height={180} className="rounded-full" /></DrawerTitle>
                      <DrawerDescription>
     ...
     <div className="flex flex-wrap items-center gap-4 justify-center pb-4">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <span className="ml-1 p-1 px-2 text-sm bg-secondary rounded-full text-primary text-center">{`$${maid.pricePerMonth} per Month`}</span>
        <span className="ml-1 p-1 px-2 text-sm bg-secondary rounded-full text-primary text-center">{`$${maid.pricePerHour} per Hour`}</span>
        </div>
      </div>   
